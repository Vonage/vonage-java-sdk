...
public class GetBroadcastEndpointTest {
	private GetBroadcastEndpoint endpoint;
	private final String applicationId = UUID.randomUUID().toString();
	
	@BeforeEach
	public void setUp() {
		endpoint = new GetBroadcastEndpoint(new HttpWrapper(
	...
	public void testMakeRequest() throws Exception {
		...
		String expectedUri = "https://video.api.vonage.com/v2/project/"+applicationId +"/broadcast/"+broadcastId;
	...
	public void testCustomUri() throws Exception {
		...
		endpoint = new GetBroadcastEndpoint(wrapper);
		String expectedUri = baseUri + "/v2/project/"+applicationId+"/broadcast/"+broadcastId;
		RequestBuilder builder = endpoint.makeRequest(broadcastId);
		Assertions.assertEquals(expectedUri, builder.build().getURI().toString());
		Assertions.assertEquals(ContentType.APPLICATION_JSON.getMimeType(), builder.getFirstHeader("Accept").getValue());
		Assertions.assertEquals("GET", builder.getMethod());
