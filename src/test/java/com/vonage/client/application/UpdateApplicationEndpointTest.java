...
public class UpdateApplicationEndpointTest extends ApplicationMethodTest {
    private UpdateApplicationEndpoint method;

    @Before
    public void setUp() {
        method = new UpdateApplicationEndpoint(new HttpWrapper());
    }
    ...
    public void testCustomUri() throws Exception {
        ...
        UpdateApplicationEndpoint method = new UpdateApplicationEndpoint(wrapper);
