...
public class ListApplicationsEndpointTest extends ApplicationMethodTest {
    private ListApplicationsEndpoint method;

    @Before
    public void setUp() {
        method = new ListApplicationsEndpoint(new HttpWrapper());
    }
    ...
    public void testCustomUriWithNoParameters() throws Exception {
        ...
        ListApplicationsEndpoint method = new ListApplicationsEndpoint(wrapper);
