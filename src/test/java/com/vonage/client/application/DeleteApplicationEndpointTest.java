...
public class DeleteApplicationEndpointTest extends ApplicationMethodTest {
    private DeleteApplicationEndpoint method;

    @Before
    public void setUp() {
        method = new DeleteApplicationEndpoint(new HttpWrapper());
    }
    ...
    public void testCustomUri() throws Exception {
        ...
        DeleteApplicationEndpoint method = new DeleteApplicationEndpoint(wrapper);
