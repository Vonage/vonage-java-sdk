...
public class HashUtilTest {
    ...
    public void testHmacSHA512() throws Exception {
        assertEquals(
                ...
                calculate(INPUT, SECRET, HMAC_SHA512)
        );
        assertEquals(
    ...
    public void testHmacSHA256() throws Exception {
        assertEquals(
                ...
                calculate(INPUT, SECRET, HMAC_SHA256)
        );
        assertEquals(
    ...
    public void testHmacSHA1() throws Exception {
        assertEquals(
                ...
                calculate(INPUT, SECRET, HMAC_SHA1)
        );
        assertEquals(
    ...
    public void testHmacMD5() throws Exception {
        assertEquals(
                ...
                calculate(INPUT, SECRET, HMAC_MD5)
        );
        assertEquals(
    ...
    public void testMD5() throws Exception {
        ...
        assertEquals(expected, calculate(INPUT, null, MD5));
