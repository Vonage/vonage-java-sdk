...
public class ListSecretsEndpointTest {
    ListSecretsEndpoint method;

    @Before
    public void setUp() throws Exception {
        method = new ListSecretsEndpoint(new HttpWrapper());
    }
    ...
    public void testCustomUri() throws Exception {
        ...
        ListSecretsEndpoint method = new ListSecretsEndpoint(wrapper);
