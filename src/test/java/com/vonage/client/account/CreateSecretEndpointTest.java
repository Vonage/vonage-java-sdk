...
public class CreateSecretEndpointTest {
    private CreateSecretEndpoint method;

    @Before
    public void setUp() {
        method = new CreateSecretEndpoint(new HttpWrapper());
    }
    ...
    public void testCustomUri() throws Exception {
        ...
        CreateSecretEndpoint method = new CreateSecretEndpoint(wrapper);
        CreateSecretRequest request = new CreateSecretRequest("account-id", "secret");
