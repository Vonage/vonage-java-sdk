...
public class TransferCreditEndpointTest {
	...
	TransferCreditEndpoint endpoint;
	
	@Before
	public void setUp() {
		endpoint = new TransferCreditEndpoint(new HttpWrapper(authMethod));
	}
	...
	public void testCustomUri() throws Exception {
		...
		endpoint = new TransferCreditEndpoint(wrapper);
		CreditTransfer request = CreditTransfer.builder()
	...
	public void testEmptyResponse() throws Exception {
		...
		assertNull(parsed.getCreditTransferId());
