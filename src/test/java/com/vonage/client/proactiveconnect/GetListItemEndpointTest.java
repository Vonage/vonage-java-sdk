...
public class GetListItemEndpointTest {
	GetListItemEndpoint endpoint;
	String listId = UUID.randomUUID().toString();
	String itemId = UUID.randomUUID().toString();
	
	@Before
	public void setUp() {
		endpoint = new GetListItemEndpoint(new HttpWrapper());
	}
	...
	public void testDefaultUri() throws Exception {
		RequestBuilder builder = endpoint.makeRequest(new ListItemRequestWrapper(listId, itemId, null));
	...
	public void testCustomUri() throws Exception {
		...
		endpoint = new GetListItemEndpoint(wrapper);
