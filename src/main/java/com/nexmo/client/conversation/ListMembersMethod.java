...
public class ListMembersMethod extends AbstractMethod<CursorListFilter, MemberPage> {
    private static final String PATH = "/conversations/";
    private static final Class[] ALLOWED_AUTH_METHODS = new Class[]{JWTAuthMethod.class};

    ListMembersMethod(HttpWrapper httpWrapper){super(httpWrapper);}
    ...
    public RequestBuilder makeRequest(CursorListFilter filter) throws UnsupportedEncodingException {
        ...
        String uri = httpWrapper.getHttpConfig().getVersionedApiBaseUri("v0.1") + PATH + filter.getConversation_id() + "/members";
    ...
    @Override
    public MemberPage parseResponse(HttpResponse response) throws IOException {
