...
/**
 * Represents a suggested action to share the user's location in an RCS message.
 *
 * @since 9.6.0
 */
public class RcsSuggestedActionShareLocation extends JsonableBaseObject implements RcsSuggestion {
	private String text, postbackData;

	protected RcsSuggestedActionShareLocation() {
	}

	private RcsSuggestedActionShareLocation(Builder builder) {
	...
	public static class Builder {
		...
		/**
		 * Builds the RcsSuggestedActionShareLocation object.
		 *
		 * @return A new {@linkplain RcsSuggestedActionShareLocation}.
		 */
		public RcsSuggestedActionShareLocation build() {
			return new RcsSuggestedActionShareLocation(this);
		}
	}
}
