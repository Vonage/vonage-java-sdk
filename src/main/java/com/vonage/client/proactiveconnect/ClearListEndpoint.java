...
class ClearListEndpoint extends AbstractMethod<String, Void> {
	private static final Class<?>[] ALLOWED_AUTH_METHODS = {JWTAuthMethod.class};
	private static final String PATH = "/v0.1/bulk/lists/%s/clear";

	ClearListEndpoint(HttpWrapper httpWrapper) {
		super(httpWrapper);
	}
