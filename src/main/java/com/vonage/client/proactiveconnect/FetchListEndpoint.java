...
class FetchListEndpoint extends AbstractMethod<String, Void> {
	private static final Class<?>[] ALLOWED_AUTH_METHODS = {JWTAuthMethod.class};
	private static final String PATH = "/v0.1/bulk/lists/%s/fetch";

	FetchListEndpoint(HttpWrapper httpWrapper) {
		super(httpWrapper);
	}
