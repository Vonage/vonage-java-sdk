 ...
 * @since 8.19.0
 */
public final class MemberMediaEvent extends EventWithBody<MemberMediaEvent.MemberMediaBody> {
	MemberMediaEvent() {}

	/**
	 * The main body container a MemberMediaEvent.
	 */
	static class MemberMediaBody extends JsonableBaseObject {
