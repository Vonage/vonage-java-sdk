 ...
 * @since 8.19.0
 */
public final class AudioDtmfEvent extends EventWithBody<AudioDtmfEventBody> {
     ...
     */
    public static final class Builder extends EventWithBody.Builder<AudioDtmfEvent, Builder> {
        String digits;
        Integer dtmfSeq;
         ...
         * @return This builder.
         */
        public  Builder dtmfSeq(Integer dtmfSeq) {
            this.dtmfSeq = dtmfSeq;
            return this;
        }

        /**
         * Set the channel data for the event.
         *
         * @param channel The channel object for the event.
         *
         * @return This builder.
         */
