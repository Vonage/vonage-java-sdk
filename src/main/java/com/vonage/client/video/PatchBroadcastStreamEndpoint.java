...
class PatchBroadcastStreamEndpoint extends AbstractMethod<PatchComposedStreamsRequest, Void> {
	private static final Class<?>[] ALLOWED_AUTH_METHODS = {JWTAuthMethod.class};
	private static final String PATH = "/v2/project/%s/broadcast/%s/streams";

	PatchBroadcastStreamEndpoint(HttpWrapper httpWrapper) {
		super(httpWrapper);
	}
