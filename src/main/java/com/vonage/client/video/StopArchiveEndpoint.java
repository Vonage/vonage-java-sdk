...
class StopArchiveEndpoint extends AbstractMethod<String, Archive> {
	private static final Class<?>[] ALLOWED_AUTH_METHODS = {JWTAuthMethod.class};
	private static final String PATH = "/v2/project/%s/archive/%s/stop";

	StopArchiveEndpoint(HttpWrapper httpWrapper) {
		super(httpWrapper);
	}
	...
	public RequestBuilder makeRequest(String archiveId) {
		...
		return RequestBuilder.post(uri).setHeader("Accept", "application/json");
	}
