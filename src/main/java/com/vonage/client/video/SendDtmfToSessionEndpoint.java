...
class SendDtmfToSessionEndpoint extends AbstractMethod<SendDtmfRequest, Void> {
	private static final Class<?>[] ALLOWED_AUTH_METHODS = {JWTAuthMethod.class};
	private static final String PATH = "/v2/project/%s/session/%s/play-dtmf";

	SendDtmfToSessionEndpoint(HttpWrapper httpWrapper) {
		super(httpWrapper);
	}
