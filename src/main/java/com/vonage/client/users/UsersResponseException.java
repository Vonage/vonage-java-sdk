...
public final class UsersResponseException extends VonageApiResponseException {
	 ...
	 */
	@JsonCreator
	public static UsersResponseException fromJson(String json) {
		return fromJson(UsersResponseException.class, json);
	}
}
